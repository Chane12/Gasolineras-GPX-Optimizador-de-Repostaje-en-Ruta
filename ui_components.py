        ...
        with st.container(border=True):
            ...
            with btn_cols[0]:
                if maps_url and maps_url != "nan":
                    st.link_button("🗺️ Maps", url=maps_url, use_container_width=True, help="Abrir en Google Maps")
            with btn_cols[1]:
                if ya_en_plan:
                    st.button(
                        "✅ En plan",
                        ...
                        help="Esta estación ya ha sido añadida a tu plan",
                    )
                else:
                    if st.button(
                        "➕ Añadir",
                        ...
                        use_container_width=True,
                        type="primary",
                        help="Añadir esta estación a tu plan de viaje",
                    ):
