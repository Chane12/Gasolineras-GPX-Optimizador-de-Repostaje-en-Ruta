...
def enrich_stations_with_osrm(
    ...
    rutas_origen_dict = {}
    # Optimization: Use Shapely 2.0 C-vectorized functions instead of pandas .apply()
    ...
    coords = shapely.get_coordinates(nearest_points)
    for idx, (x, y) in zip(gdf_wgs84.index, coords, strict=False):
